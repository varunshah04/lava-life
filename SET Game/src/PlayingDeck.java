...
public class PlayingDeck {
	...
	public void removeSelected(int num){
		cardsInPlayed.removeAll(selectedCards);
		deSelect();
	...
	public void display(Graphics p){
		...
		int counter = 0;
		for (int j = 0; j < canvasHeight && counter < currentCards ; j = j + cardHeight){
			for (int k = 0; k < (canvasWidth - cardWidth) && counter < currentCards; k = k + cardWidth){
